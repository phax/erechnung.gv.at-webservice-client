...
/**
 * Example for invoking the Webservice 2.0 for ER>B - E-Rechnung an den Bund.
 * 
 * @author Philip Helger
 */
public final class WS200UploadDemo
{
  // Settings start here
  ...
  // Logger to use
  private static final Logger s_aLogger = LoggerFactory.getLogger (WS200UploadDemo.class);
  ...
  public static void main (final String [] args) throws Exception
  {
    ...
    final String sDemoEbInterface = "<?xml version=\"1.0\" encoding=\"" +
                                    ...
                                    "      <eb:Email>demo@x-erechnung-webservice200.at</eb:Email>\n" +
                                    "    </eb:Address>\n" +
                                    "  </eb:Biller>\n" +
                                    "  <eb:InvoiceRecipient>\n" +
    ...
    aInvoice.setValue (CharsetManager.getAsBytes (sDemoEbInterface, ENCODING));
    aInvoice.setEncoding (ENCODING.name ());
    aDelivery.setInvoice (aInvoice);

    // No attachments
    aDelivery.setEmbeddedAttachment (null);
    ...
    aBP.getRequestContext ().put (BindingProvider.ENDPOINT_ADDRESS_PROPERTY, "https://txm.portal.at/at.gv.bmf.erb/V2");
